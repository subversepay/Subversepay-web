...
export function PlatformCard({ platform }: { platform: PlatformProps }) {
  return (
    <div className="relative group h-full">
      ...
      <div className="relative bg-background/50 backdrop-blur-sm rounded-xl p-6 z-10 border border-brand-blue/10 hover:border-brand-blue/30 transition-colors h-full flex flex-col">
        ...
        <h3 className="text-xl font-semibold mb-2 text-foreground">{platform.name}</h3>
        ...
        <div className="space-y-3 mb-4 flex-grow">
          ...
          <div>
            ...
            <div className="text-accent font-medium">{platform.discount}</div>
          </div>
        </div>

        <Button className="w-full bg-brand-blue hover:bg-brand-blue/90 text-primary-foreground relative overflow-hidden group">
