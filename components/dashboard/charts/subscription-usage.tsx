  ...
  return (
    <div className="bg-background/40 backdrop-blur-sm border border-brand-blue/20 rounded-xl p-5">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-lg font-medium text-foreground">{isB2B ? "API Integration Usage" : "Subscription Usage"}</h2>
              ...
              {currentData.map((value, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Tooltip */}
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-background/90 border border-brand-blue/30 rounded px-2 py-1 text-xs text-primary-foreground whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
